...
class TestBase_to_json_string(unittest.TestCase):
    """Unittests for JSON serialization method of Base class."""
...
class TestBase_save_to_file(unittest.TestCase):
    """Unittests for text file method of the Base class."""
    ...
    def test_save_to_file_one_rectangle(self):
        ...
        with open(file="Rectangle.json", mode="r") as fr:
            self.assertTrue(len(fr.read()) == 53)

    def test_save_to_file_two_rectangles(self):
        r1 = Rectangle(10, 7, 2, 8, 6)
        r2 = Rectangle(2, 5, 4, 7, 3)
        Rectangle.save_to_file([r1, r2])
        with open(file="Rectangle.json", mode="r") as fr:
            self.assertTrue(len(fr.read()) == 105)

    def test_save_to_file_one_square(self):
        s = Square(10, 7, 2, 8)
        Square.save_to_file([s])
        with open("Square.json", "r") as fr:
            self.assertTrue(len(fr.read()) == 39)
